...
NDefines.NProduction.MIN_POSSIBLE_TRAINING_MANPOWER = 10000000	-- Vanilla 100000 -- How many deployment lines minimum can be training
NDefines.NAir.COMBAT_BETTER_SPEED_DAMAGE_INCREASE = 1.0	
NDefines.NAir.TOP_SPEED_DAMAGE_BONUS_FACTOR = 0
NDefines.NMilitary.ARMY_LEADER_XP_GAIN_PER_UNIT_IN_COMBAT = 0.125 -- XP gain per unit in combat
NDefines.NMilitary.PIERCING_THRESHOLDS = {                    -- Our piercing / their armor must be this value to deal damage fraction equal to the index in the array below [higher number = higher penetration]. If armor is 0, 1.00 will be returned.
    1.00,
    0.95,
...
NDefines.NMilitary.PIERCING_THRESHOLD_DAMAGE_VALUES = {    -- 0 armor will always receive maximum damage (so add overmatching at your own peril). the system expects at least 2 values, with no upper limit.
    ...
    0.20, -- 0.2
    0.15,
    0.10, -- minimum dmg we receive at 0 piercing (never happens)
	0.05
}
NDefines.NIntel.STATIC_INTEL_SOURCE_INTEL_NETWORK_MAXIMUMS = { 40.0, 40.0, 40.0, 40.0 }
...
NDefines.NDiplomacy.NAVAL_BLOCKADE_BASE_COST = 9999						-- Base PP cost for issuing a naval blockade
-- NDefines.NDiplomacy.NAVAL_BLOCKADE_DAILY_COST = 0.1,					-- Daily PP cost for one naval blockade
NDefines.NDiplomacy.NAVAL_BLOCKADE_THREAT_THRESHOLD = 100				-- Target-generated threat threshold to allow naval blockade
NDefines.NDiplomacy.DIPLOMATIC_ACTION_NAVAL_BLOCKADE_BASE_SCORE  = -700
...
NDefines.NBuildings.INFRASTRUCTURE_RESOURCE_BONUS = 0.04 -- multiplactive resource bonus for each level of (non damaged) infrastructure

NDefines.NMilitary.TRAINING_MAX_LEVEL = 8
...
NDefines.NAir.AIR_WING_XP_LEVELS = { 90, 180, 270, 360, 450, 540, 630, 720, 830, 950 } 	-- Experience needed to progress to the next level
NDefines.NAir.AIR_WING_XP_TRAINING_MAX = 540.0
NDefines.NAir.AIR_WING_XP_TRAINING_MISSION_GAIN_DAILY = 5.0
